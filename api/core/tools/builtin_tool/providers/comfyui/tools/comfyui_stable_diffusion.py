...
from core.tools.entities.tool_entities import ToolInvokeMessage, ToolParameter, PluginParameterOption
                ...
                if len(models) != 0:
                    parameters.append(
                        ToolParameter(
                            ...
                            default=models[0],
                            options=[
                                PluginParameterOption(value=i, label=I18nObject(en_US=i, zh_Hans=i)) for i in models
                            ],
                        )
                    )
                    ...
                    for n in range(1, 4):
                        parameters.append(
                            ToolParameter(
                                ...
                                required=False,
                                options=[
                                    PluginParameterOption(value=i, label=I18nObject(en_US=i, zh_Hans=i)) for i in loras
                                ],
                            )
                        )
                ...
                if len(sample_methods) != 0:
                    parameters.append(
                        ToolParameter(
                            ...
                            options=[
                                PluginParameterOption(value=i, label=I18nObject(en_US=i, zh_Hans=i))
                ...
                if len(schedulers) != 0:
                    parameters.append(
                        ToolParameter(
                            ...
                            options=[
                                PluginParameterOption(value=i, label=I18nObject(en_US=i, zh_Hans=i)) for i in schedulers
                            ],
                        )
                    )
                parameters.append(
