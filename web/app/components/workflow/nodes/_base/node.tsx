    ...
    >
      <div
        className={cn(
          ...
          (data.type === BlockEnum.Iteration || data.type === BlockEnum.Collect) && 'flex flex-col w-full h-full bg-workflow-block-bg-transparent border-workflow-block-border',
      ...
      >
        ...
        <div className={cn(
          ...
          (data.type === BlockEnum.Iteration || data.type === BlockEnum.Collect) && 'bg-transparent',
        )}>
          <BlockIcon
